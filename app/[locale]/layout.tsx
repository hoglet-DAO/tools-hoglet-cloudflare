          ...
          <NetworkProvider>
            <SupraWalletProvider>
              ...
              <footer className="mt-auto py-6 text-center text-[11px] text-zinc-500">
                Hoglet Tools is a non-custodial infrastructure. Provided As-Is without warranties. <a href="#" target="_blank" rel="noopener noreferrer" className="underline hover:text-zinc-300 transition-colors">Read our Open-Source Terms</a>.
              </footer>
            </SupraWalletProvider>
          </NetworkProvider>
